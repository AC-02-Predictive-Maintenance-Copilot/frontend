...
function ChatDesc({ user }) {
  ...
  return (
    <div className="p-4 w-[50%] mx-auto">
      <h2 className="text-4xl font-bold mb-2 bg-linear-to-r from-zinc-900 to-zinc-400 via-zinc-500 dark:from-zinc-50 dark:to-zinc-500 dark:via-zinc-400 bg-clip-text text-transparent pb-1">
